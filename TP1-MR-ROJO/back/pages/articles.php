    ...
    <div class="admin-container">
        ...
        <div class="sidebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li><a href="/admin/articles/" class="active"><svg class="icon" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path fill="currentColor" d="M6 2h9l5 5v15a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2zm8 1.5V8h4.5L14 3.5zM8 11h8v2H8v-2zm0 4h8v2H8v-2z"/></svg><span class="sidebar-link-label">Gerer les articles</span></a></li>
